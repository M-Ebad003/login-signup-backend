      ...
      <div className='w-full text-white max-w-sm shadow-lg p-10 space-y-8 bg-[#10103f] rounded-lg'>
        ...
        <Form {...form} >
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex justify-center items-center">
              <Button type="submit" disabled={isSubmitting} className=' disabled:opacity-55'>
                {isSubmitting ? (
                  <>
        ...
        <div className="text-center mt-4">
          <p>
            ...
            <Link href='/sign-up' className="text-blue-600 hover:text-blue-800">Register here</Link>
          </p>
        </div>
      </div>
    </div>
